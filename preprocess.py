...
dataset_path='/home/sniu/lab/ai_lab/rnnAutoEncoder/data/'
...
tokenizer_cmd = ['./utils/mosesdecoder/scripts/tokenizer/tokenizer.perl', '-l', 'en', '-q', '-']
...
def main():
    ...
    f = open('imdb_sup.pkl', 'wb')
    pkl.dump((train_x, train_y), f, -1)
    pkl.dump((test_x, test_y), f, -1)
    f.close()

    f = open('imdb_unsup.pkl', 'wb')
    pkl.dump((train_x_unsup), f, -1)
    f.close()
